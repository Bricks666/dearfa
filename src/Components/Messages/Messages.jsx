    ...
    return (
        ...
        >
            <Message author={props.name}>
                ...
                Летит на пламя, <br/>
                Слетались хлопья со двора<br/>К оконной раме.<br/>
                ...
                Судьбы скрещенья. <br/>И падали два башмачка<br/>
                Со стуком на пол.<br/>И воск слезами с ночника <br/>
                На платье капал. <br/>И все терялось в снежной мгле<br/>
                Седой и белой. <br/>
                Свеча горела на столе, <br/>
                Свеча горела. <br/>
                На свечку дуло из угла,<br/>И жар соблазна <br/>
